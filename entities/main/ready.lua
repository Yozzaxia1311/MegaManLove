client_ready = entity:extend()

client_ready.netName = "c_ready"
megautils.netNames[client_ready.netName] = client_ready

function client_ready:new(text, id)
  client_ready.super.new(self)
  self:setLayer(9)
  self.once = false
  self.render = false
  self.blinkTimer = 0
...
function client_ready:update(dt)
